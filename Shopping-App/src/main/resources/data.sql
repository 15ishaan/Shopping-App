...
insert into USER values(1, 'X', 'Gupta', 'X@gmail.com', 'ABC', 'ABC', 'user', 5000, true);
insert into USER values(2, 'Y', 'Mehta', 'Y@gmail.com', 'ABC', 'ABC', 'user', 5000, true);
insert into USER values(3, 'Z', 'Deshmukh', 'Z@gmail.com', 'ABC', 'ABC', 'user', 5000, true);
